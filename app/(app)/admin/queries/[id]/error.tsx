...
export default function QueryDetailError({
  error,
  reset,
}: {
  ...
  return (
    <div className="flex min-h-[60vh] items-center justify-center">
      <Card className="max-w-md" role="alert">
        <CardEyebrow>Query error</CardEyebrow>
        <CardTitle>We couldn&apos;t load this citizen query.</CardTitle>
        <CardDescription>
          The data layer returned an unexpected error. Your work is safe — try again, or go back to
          the inbox. If this keeps happening, send the reference below to{' '}
          <a
