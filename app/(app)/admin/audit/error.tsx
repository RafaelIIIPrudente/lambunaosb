...
export default function AuditError({
  ...
  useEffect(() => {
    Sentry.captureException(error, { tags: { route: 'admin/audit' } });
  }, [error]);

  return (
    <div className="flex min-h-[60vh] items-center justify-center">
      <Card className="max-w-md" role="alert">
        <CardEyebrow>Audit error</CardEyebrow>
        <CardTitle>We couldn&apos;t load the audit log.</CardTitle>
        <CardDescription>
          The data layer returned an unexpected error. Audit data itself is intact — try again, or
          reload the page. If this keeps happening, send the reference below to{' '}
          <a
