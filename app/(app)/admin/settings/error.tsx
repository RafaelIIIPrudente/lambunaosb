...
export default function SettingsError({
  ...
  useEffect(() => {
    Sentry.captureException(error, { tags: { route: 'admin/settings' } });
  }, [error]);

  return (
    <div className="flex min-h-[60vh] items-center justify-center">
      <Card className="max-w-md" role="alert">
        <CardEyebrow>Settings error</CardEyebrow>
        <CardTitle>We couldn&apos;t load your settings.</CardTitle>
        <CardDescription>
          The data layer returned an unexpected error. Your saved settings are intact — try again,
          or reload the page. If this keeps happening, send the reference below to{' '}
          <a
