  ...
  return (
    ...
    >
      ...
      <div className="grid gap-4 md:grid-cols-2">
        ...
        <Field label="Email · for our reply" required error={form.formState.errors.email?.message}>
          <div className="flex items-center gap-2">
      ...
      <p className="text-ink-faint mt-4 text-xs leading-relaxed italic">
        ...
        Hidden honeypot field &ldquo;website&rdquo; — a real human never sees it; bots fill it and
        get rejected.
      </p>
      ...
      <label className="border-ink/30 mt-4 flex items-start gap-3 rounded-md border border-dashed p-4">
        ...
        <span className="text-navy-primary font-display text-sm leading-relaxed italic">
          By submitting, you consent to the LGU storing your name and email only to respond to this
          query, per the Data Privacy Act of 2012 (RA 10173). Your message may be redacted before
          any public summary.
        </span>
      </label>
