            ...
            {featuredNews.map((post) => {
              ...
              return (
                <li key={post.id}>
                  <Link
                    href={`/news/${post.slug}`}
                    className="group/news border-ink/15 hover:border-ink/35 hover:shadow-e1 focus-visible:ring-rust bg-paper flex h-full flex-col gap-4 rounded-md border p-4 transition-all focus-visible:ring-2 focus-visible:outline-none"
                  >
                    {coverUrl ? (
                ...
                return (
                  <li key={member.id}>
                    <Link
                      ...
                      className="group/member border-ink/15 hover:border-ink/35 hover:shadow-e1 focus-visible:ring-rust bg-paper flex h-full flex-col gap-4 rounded-md border p-4 transition-all focus-visible:ring-2 focus-visible:outline-none"
                    >
                      {photoUrl ? (
